...
class InterventionType(BaseEntity, db.Model):
    """Reference table for intervention types.
    """

    __tablename__ = 'intervention_types'

    intervention_type_id = db.Column(db.Integer, primary_key=True, autoincrement=True)
    intervention_type_name = db.Column(db.String(64), unique=True, nullable=False)
